...
response = s3Client.copy_object(
    Bucket = 'das-demos-310',
    CopySource = '/das-demos-310/boto3put.txt',
...
s3Resource.meta.client.upload_file(boto3Upload, 'das-demos-310', boto3Upload)

# upload_fileobj
with open(boto3Upload, 'rb') as fileObj:
    response = s3Client.upload_fileobj(fileObj, 'das-demos-310', 'boto3uploadobj.txt')
    print(response)
